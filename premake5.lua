workspace "HDBQuickstartTemplate"
   ...
   defines { "rsc_CompanyName=\"hdbeefup template\"" }
   defines { "rsc_LegalCopyright=\"hdbeefup template\""}
   defines { "rsc_FileVersion=\"1.0.0.0\"", "rsc_ProductVersion=\"1.0.0.0\"" }
   defines { "rsc_InternalName=\"%{prj.name}\"", "rsc_ProductName=\"%{prj.name}\"", "rsc_OriginalFilename=\"%{prj.name}.asi\"" }
   defines { "rsc_FileDescription=\"https://github.com/hdbeefup\"" }
   defines { "rsc_UpdateUrl=\"https://github.com/hdbeefup\"" }
...
project "template.game1"
   setpaths("C:/Games/Game", "game.exe")
project "hdbeefup.lab"
   setpaths("C:/Games/Gamer/scripts", "editor.exe")